...
struct ModelOperationLogs {
    ...
    6: string operation(go.tag='json:"operation" gorm:"column:operation"');
    7: string object_type(go.tag='json:"object_type" gorm:"column:object_type"');
    8: string object_id(go.tag='json:"object_id" gorm:"column:object_id"');
    9: string details(go.tag='json:"details" gorm:"column:details;type:text"');
    10: string ip_address(go.tag='json:"ip_address" gorm:"column:ip_address"');
    11: i32 status(go.tag='json:"status" gorm:"column:status"');
